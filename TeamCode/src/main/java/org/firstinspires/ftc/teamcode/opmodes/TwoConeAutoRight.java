...
@Autonomous(name="Two Cone Auto Right",group="Exercises")
public class TwoConeAutoRight extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        drivetrain.drive(52); // changed
        drivetrain.rotateTo(-90,0.1);
        drivetrain.drive(4,0.2);
